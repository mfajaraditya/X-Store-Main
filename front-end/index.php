            ...
            <div class="box_iklan_flash_sale">
              ...
              ?>
                <div class="iklan_flash_sale">
                  <a href="<?php echo $url; ?>produk/produk/<?php echo $flash_sale_data['id']; ?>">
                    <div class="box_persen_flashsale">
                      <p>-<?php echo $flash_sale_data['diskon']; ?>%</p>
                    </div>
                    <img src="./assets/images/<?php echo $exp_gambar_fs[0]; ?>">
        ...
        <div class="box_iklan_flash_sale grid_terlaris">
          ...
          ?>
            <div class="list_produk">
              <a href="<?php echo $url; ?>produk/produk/<?php echo $produk_terlaris_data['id']; ?>">
                <img src="./assets/images/<?php echo $exp_gambar_pt[0]; ?>">
