daftar.onclick = function () {
     ...
     if (cek_nama_lengkap == true && cek_email == true && cek_no_whatsapp == true && cek_password == true) {
         ...
         data_register.append("nama_lengkap", document.getElementById('nama-lengkap').value);
         data_register.append("email", document.getElementById('email').value);
         data_register.append("no_whatsapp", document.getElementById('no-whatsapp').value);
         ...
         xhttp.open("POST", "../sistem/daftar/daftar.php", true);
